...
void TFRSParameter::Print(Option_t*) const {	
  ...
  std::cout << "after_run176 = " << after_run176  << std::endl;
  
  std::cout << "max_scaler = " << max_scaler << std::endl;
  ...
  std::cout << "Dist_MW41=" << dist_MW41 << std::endl;				       
  std::cout << "Dist_MW42=" << dist_MW42 << std::endl; 				
  std::cout << "Dist_MW43=" << dist_MW43 << std::endl;				
  std::cout << "Dist_SC41=" << dist_SC41 << std::endl;					
  std::cout << "Dist_SC42=" << dist_SC42 << std::endl;					
  std::cout << "Dist_SC43=" << dist_SC43 << std::endl;				 
  std::cout << "Dist_MUSICa1=" << dist_MUSICa1 << std::endl;			
  std::cout << "Dist_MUSICa2=" << dist_MUSICa2 << std::endl; 		
  std::cout << "Dist_MUSICa3=" << dist_MUSICa3 << std::endl; 			
  std::cout << "Dist_MUSICa4=" << dist_MUSICa4 << std::endl;		
  std::cout << "Dist_MUSIC1="  << dist_MUSIC1  << std::endl;  			
  std::cout << "Dist_MUSIC2="  << dist_MUSIC2  << std::endl; 				
  std::cout << "Dist_MUSIC3="  << dist_MUSIC3  << std::endl; 	
  ...
  std::cout << "offest_z = " << offset_z << std::endl;
  std::cout << "offest_z2 = " << offset_z2 << std::endl;
  std::cout << "offest_z3 = " << offset_z3 << std::endl;  
  return ; 
}
...
void TIDParameter::Print(Option_t*) const {
  ...
  std::cout << "x2_select = " << x2_select << std::endl;  
  std::cout << "x4_select = " << x4_select << std::endl;  
  std::cout << "x8_select = " << x8_select << std::endl; 
