...
void TFRSCalibrProc::Create_TPC_Data()
{
  ...
  Float_t lim_csum1[6][2]={{500,1800},{500,1800},{500,1800},{500,1700},{500,1000},{500,1600}};
  Float_t lim_csum2[6][2]={{500,1800},{500,1800},{500,1800},{500,1700},{500,1000},{500,1600}};
  Float_t lim_csum3[6][2]={{500,1800},{500,1840},{500,1800},{500,1700},{500,1075},{500,1620}};
  Float_t lim_csum4[6][2]={{500,1880},{500,1810},{500,1800},{500,1700},{500,1040},{500,1670}};
...
void TFRSCalibrProc::Create_SI_Data(){
...
void TFRSCalibrProc::Create_CT_Data(){
...
void TFRSCalibrProc::Create_ElCurrent_Data(){
...
void TFRSCalibrProc::Process_MON_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt) {
...
// for 1st module
  for (int i=0;i<32;i++) {
    //  if(src.sc_long[i]!=0){            
      if ( ((Long64_t) scaler_save[i]) >((Long64_t) src.sc_long[i])) {
		 if (src.trigger==12 || src.trigger==13){ continue ; }
//        std::cout <<"Hey I got overloaded !!! channel "<<i<<std::endl ; 
//        std::cout <<scaler_save[i] <<"  "<<src.sc_long[i]<<std::endl ;
//		  std::cout <<"trigger is : "<<src.trigger<<std::endl ; 
        scaler_save[i] = src.sc_long[i] - 4294967295;
        overload = 1;
      }
      // }
      tgt.mon_inc[i] = ((Long64_t)src.sc_long[i]) - ((Long64_t)scaler_save[i]); //
    
//		std::cout <<"  "<<i<<"  "<<tgt.mon_inc[i]<<"  "<<src.sc_long[i]<<"  "<<scaler_save[i]<<std::endl ; 
      if (tgt.mon_inc[i]<0){std::cout <<" WRONG"<<std::endl ;} 
...
// for 1st module
  for(int i=0;i<32;i++) {
    if (tgt.mon_inc[i]>=0) hMON_All->SetBinContent(i+1,(UInt_t) tgt.mon_inc[i]);
...
//////////////////////////////////////////////////////////////////
///  ***********TPC Analysis*************************** //////////
void TFRSCalibrProc::Process_TPC_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt)
{
  //TFRSParameter* frs = (TFRSParameter*) GetParameter("FRSPar");
...
void TFRSCalibrProc::Process_SI_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt)
{
  TSIParameter* si = (TSIParameter*) GetParameter("SIPar");
  //TFRSParameter* frs = (TFRSParameter*) GetParameter("FRSPar");
...
void TFRSCalibrProc::Process_CT_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt)
{
...
void TFRSCalibrProc::Process_ElCurrent_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt)
{
