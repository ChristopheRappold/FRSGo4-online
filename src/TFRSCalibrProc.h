...
class TFRSCalibrProc : public TFRSBasicProc {
   ...
   private:
      ...
      void Process_SI_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt);
      void Process_CT_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt);
      void Process_ElCurrent_Analysis(TFRSSortEvent& src, TFRSCalibrEvent& tgt);
      ...
      TH1I* MakeH1I_TPC(const char* foldername, 
       ...
       TH1I* MakeH1I_ITAG(const char* foldername, 
                       const char* name, int nameindex,
                       Int_t nbins, 
                       Float_t xmin, Float_t xmax, 
                       const char* xtitle = "channels",
