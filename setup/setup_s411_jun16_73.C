...
void setup_s411_jun16_73()
{
  ...
  // index 2 for Sc21  
  sci->x_a[0][2] =  -2065.2-27.4;  //  SC21 calibration ch->mm 27.05.2016
  ...
  */
  ...
  // from S411_73
  frs->bfield[0] = 0.6245;      // FRS D3 field [Tesla] 
  frs->bfield[1] = 0.6155;      // FRS D4 field [Tesla] 
  frs->bfield[2] = 0.4991;       // FRS D3 field [Tesla] 
  frs->bfield[3] = 0.50074;      // FRS D4 field [Tesla]
