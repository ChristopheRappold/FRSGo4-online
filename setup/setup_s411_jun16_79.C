...
// =======
 ...
 id->ID_x2AoverQ[0][4][0]=2.24433;id->ID_x2AoverQ[0][4][1]=42.5864;
  ...
  // from S411_77
  //  frs->bfield[0] = 0.5021;      // FRS D3 field [Tesla] 
  //  frs->bfield[1] = 0.4945;      // FRS D4 field [Tesla] 
  //  frs->bfield[2] = 0.4178;       // FRS D3 field [Tesla] 
  //  frs->bfield[3] = 0.4192;      // FRS D4 field [Tesla]

  // from S411_78
  // frs->bfield[0] = 0.4958;      // FRS D3 field [Tesla] 
  // frs->bfield[1] = 0.4884;      // FRS D4 field [Tesla] 
  // frs->bfield[2] = 0.4073;       // FRS D3 field [Tesla] 
  // frs->bfield[3] = 0.4083;      // FRS D4 field [Tesla]

  // from S411_79
  frs->bfield[0] = 0.4912;      // FRS D3 field [Tesla] 
  frs->bfield[1] = 0.4839;      // FRS D4 field [Tesla] 
  frs->bfield[2] = 0.4101;       // FRS D3 field [Tesla] 
  frs->bfield[3] = 0.41134;      // FRS D4 field [Tesla]
